...
![img](/images/docs/learntutorial/04.png)
...
### 7. transition 和 animation 的区别---了解即可 `3`
...
### 10. 对 requestAnimationframe 的理解 `4`
...
![image](/images/docs/learntutorial/04-0.png)

![img](/images/docs/learntutorial/04-1.png)
...
### 12. 为什么有时候用translate来改变位置而不是定位？ `4`
...
### 13. li 与 li 之间有看不见的空白间隔是什么原因引起的？如何解决？ `4`
...
### 18. 什么是物理像素，逻辑像素和像素密度，为什么在移动端开发时需要用到@3x, @2x 这种图片？ `3`
...
![img](/images/docs/learntutorial/04-2.jpg)
...
### 22. CSS 预处理器/后处理器是什么？为什么要使用它们？ `2`
...
### 23. ::before 和 :after 的双冒号和单冒号有什么区别？ `4`
...
![image](/images/docs/learntutorial/04-3.png)
...
![img](/images/docs/learntutorial/04-4.png)
...
![img](/images/docs/learntutorial/04-5.png)
...
![img](/images/docs/learntutorial/04-6.png)
...
![img](/images/docs/learntutorial/04-7.png)

**fixed：**元素的定位是相对于 window （或者 iframe）边界的，和其他元素没有关系。但是它具有破坏性，会导致其他元素位置的变化。

![img](/images/docs/learntutorial/04-8.png)

**absolute：**元素的定位相对于前两者要复杂许多。如果为 absolute 设置了 top、left，浏览器会根据什么去确定它的纵向和横向的偏移量呢？答案是浏览器会递归查找该元素的所有父元素，如果找到一个设置了`position:relative/absolute/fixed`的元素，就以该元素为基准定位，如果没找到，就以浏览器边界定位。如下两个图所示：

![img](/images/docs/learntutorial/04-9.png)

![img](/images/docs/learntutorial/04-10.png)

### 7. display、float、position 的关系 `2`
...
![image](/images/docs/learntutorial/04-11.png)
...
![image](/images/docs/learntutorial/04-12.png)
...
![image](/images/docs/learntutorial/04-13.png)
...
![image](/images/docs/learntutorial/04-14.png)
...
![image](/images/docs/learntutorial/04-15.png)
...
![image](/images/docs/learntutorial/04-16.png)
...
![image](/images/docs/learntutorial/04-17.png)
...
![image](/images/docs/learntutorial/04-18.png)
